...
Gate: `./mvnw clean verify` green (includes race IT + pipeline IT + JWT).

## Still open (next ordered slice)
1. Grafana dashboard JSON, Helm/k8s, custom domains, audit log, versioning CI, assessment-doc refresh
