...
1. Redis + Kafka Testcontainers IT (exercise cache/rate-limit/outbox; drop JaCoCo excludes)
2. Mixed public+private multi-A DNS fixture
3. Security-on JWT MockMvc tests
4. Broader Vitest coverage for auth/org UI
5. Grafana dashboard JSON, Helm/k8s, custom domains, audit log, versioning CI, assessment-doc refresh
